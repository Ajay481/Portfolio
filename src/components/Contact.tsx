      ...
      <div className="border-x border-orange w-full h-full px-16 flex flex-col">
        ...
        <div className="flex flex-1 justify-between flex-wrap-reverse pb-10">
          <p className="w-60 text-white text-lg">
            Need a frontend developer to help out? Send me an email on
            ajayryadav1109@gmail.com to discuss your project.
          </p>
          <div className="flex gap-10 pb-10">
            <a
              aria-label="Github"
              href="https://github.com/Ajay481"
              target="_blank"
              title="Github"
              id="github"
              rel="noreferrer"
            ...
            <a
              aria-label="linkedin"
              href="https://www.linkedin.com/in/ajay-yadav-b31704153/"
              target="_blank"
              title="linkedin"
              id="linkedin"
              rel="noreferrer"
